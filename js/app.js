 ...
 */
        ...
        function initSliders() {
            if (document.querySelector(".main-header")) new core(".main-header__slider", {
                modules: [ Pagination ],
                observer: true,
                autoplay: {
                    delay: 3e3,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (targetElement.classList.contains("item-product__shop")) {
                ...
                if (targetElement.classList.contains("cart-header__shop") || targetElement.closest(".cart-header__shop")) {
                    ...
                    e.preventDefault();
                } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("item-product__shop")) document.querySelector(".cart-header").classList.remove("_active");
